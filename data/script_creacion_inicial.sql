...
IF OBJECT_ID('SFX.t_func_rol') IS NOT NULL --SFX.t_func_rol
...
IF OBJECT_ID('SFX.t_menu') IS NOT NULL
DROP TABLE SFX.t_menu
...
IF OBJECT_ID('SFX.vw_Rol_Func_Existencia') IS NOT NULL
DROP VIEW SFX.vw_Rol_Func_Existencia
IF OBJECT_ID('SFX.vw_menu') IS NOT NULL
DROP VIEW SFX.vw_menu
IF OBJECT_ID('SFX.GetViajesDisponibles') IS NOT NULL
DROP PROCEDURE SFX.GetViajesDisponibles
IF OBJECT_ID('SFX.BajaRuta') IS NOT NULL
DROP PROCEDURE SFX.BajaRuta
IF OBJECT_ID('SFX.InsertarRuta') IS NOT NULL
DROP PROCEDURE SFX.InsertarRuta
...
IF OBJECT_ID('SFX.InsertarCiudad') IS NOT NULL
DROP PROCEDURE SFX.InsertarCiudad
IF OBJECT_ID('SFX.sp_ABM_Rol') IS NOT NULL
DROP PROCEDURE SFX.sp_ABM_Rol
IF OBJECT_ID('SFX.fn_menu_usuario') IS NOT NULL
DROP FUNCTION SFX.fn_menu_usuario
IF OBJECT_ID('SFX.fn_Busqueda_Roles') IS NOT NULL
DROP FUNCTION SFX.fn_Busqueda_Roles
IF OBJECT_ID('SFX.IniciarSesion') IS NOT NULL
DROP PROCEDURE SFX.IniciarSesion
...
IF OBJECT_ID('SFX.KgDisponible') IS NOT NULL
DROP FUNCTION SFX.KgDisponibles

IF OBJECT_ID('SFX.trg_rol_desactivado') IS NOT NULL
DROP TRIGGER SFX.trg_rol_desactivado
...
--Creación tabla "Menu"
CREATE TABLE SFX.t_menu 
(men_id int identity constraint pk_menu_id primary key
,men_desc varchar(255)
,men_fun_id int
,men_formulario varchar(255)
,men_id_padre int)
...
ADD CONSTRAINT FK_t_premio_canje_02 FOREIGN KEY (pca_cli_id) 
    REFERENCES SFX.t_clientes (Cli_Id)
ALTER TABLE SFX.t_menu
ADD CONSTRAINT FK_t_menu_fun_id FOREIGN KEY (men_fun_id) 
    REFERENCES SFX.t_funcionalidades (Fun_Id)
...
----------------------------------------------------------------------------------------------------------------------------------------------------------
INSERT INTO SFX.t_roles (Rol_Nombre,rol_activo) VALUES ('Administrador General', 1)
INSERT INTO SFX.t_roles (Rol_Nombre,rol_activo) VALUES ('Cliente', 1)
...
VALUES ('ADMIN', 'e6b87050bfcb8143fcb8db0170a4dc9ed00d904ddd3e2a4ad1b1e8dc0fdc9be7', GETDATE(), NULL, 'pregunta', 'respuesta',NULL)

INSERT INTO SFX.t_usuarios (Usu_Username,Usu_Password,Usu_Fecha_Creacion,Usu_Fecha_Modif,Usu_Preg_Secreta,
							Usu_Resp_Secreta,Usu_Fecha_Baja)
VALUES ('CLIENTE', 'b3e7ebd06065a233a9ea9838c91a89d37ff6ed1aea15b5ce6cfbad1faf10f763', GETDATE(), NULL, 'pregunta', 'respuesta',NULL)
...
INSERT INTO [SFX].[t_funcionalidades] VALUES ('compra') --CLIENTE
INSERT INTO [SFX].[t_funcionalidades] VALUES ('devolucion_cancelacion')
INSERT INTO [SFX].[t_funcionalidades] VALUES ('consulta_millas') --CLIENTE
INSERT INTO [SFX].[t_funcionalidades] VALUES ('canje_millas') --CLIENTE
INSERT INTO [SFX].[t_funcionalidades] VALUES ('listados')


INSERT INTO [SFX].[t_rol_usuario] VALUES (1,1) 
INSERT INTO [SFX].[t_rol_usuario] VALUES (1,2) 
...
INSERT INTO [SFX].[t_func_rol] VALUES (9,2)
INSERT INTO [SFX].[t_func_rol] VALUES (11,2)
INSERT INTO [SFX].[t_func_rol] VALUES (12,2)


INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
VALUES(null, 'ABM Aeronaves', null, 0)
INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values(null, 'ABM Rutas', null, 0)
INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values(null, 'ABM Roles', null, 0)
INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values(null, 'ABM Ciudades', null, 0)
INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values(null, 'Millas', null, 0)
INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values(null, 'Compra', null, 0)
INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values(null, 'Listados', null, 0)

INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values ((select fun_id from  SFX.t_funcionalidades where fun_nombre = 'listados')
       , 'Listados Estadisticos', 'ListadoEstadistico',(select men_id from  SFX.t_menu where men_desc = 'Listados'))

INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values ((select fun_id from  SFX.t_funcionalidades where fun_nombre = 'abm_rol')
       , 'Alta de roles', 'AltaRoles',(select men_id from  SFX.t_menu where men_desc = 'ABM Roles'))

INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values ((select fun_id from  SFX.t_funcionalidades where fun_nombre = 'abm_rol')
       , 'Modificación de roles', 'ModificacionRoles',(select men_id from  SFX.t_menu where men_desc = 'ABM Roles'))



INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values ((select fun_id from  SFX.t_funcionalidades where fun_nombre = 'consulta_millas')
       , 'Consulta de Millas', 'ConsultaMillas',(select men_id from  SFX.t_menu where men_desc = 'Millas'))

INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values ((select fun_id from  SFX.t_funcionalidades where fun_nombre = 'canje_millas')
       , 'Canje de millas', 'CanjeMillas',(select men_id from  SFX.t_menu where men_desc = 'Millas'))

INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values ((select fun_id from  SFX.t_funcionalidades where fun_nombre = 'compra')
       , 'Compra de Pasaje/Encomienda', 'Compra',(select men_id from  SFX.t_menu where men_desc = 'Compra'))



INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values ((select fun_id from  SFX.t_funcionalidades where fun_nombre = 'abm_ruta')
       , 'Alta de Rutas', 'AltaRutas',(select men_id from  SFX.t_menu where men_desc = 'ABM Rutas'))

INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values ((select fun_id from  SFX.t_funcionalidades where fun_nombre = 'abm_ruta')
       , 'Baja de Rutas', 'BajaRutas',(select men_id from  SFX.t_menu where men_desc = 'ABM Rutas'))

INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values ((select fun_id from  SFX.t_funcionalidades where fun_nombre = 'abm_ruta')
       , 'Modificación de Rutas', 'ModificacionRutas',(select men_id from  SFX.t_menu where men_desc = 'ABM Rutas'))

INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values ((select fun_id from  SFX.t_funcionalidades where fun_nombre = 'abm_ruta')
       , 'Listado de Rutas', 'ListadoRutas',(select men_id from  SFX.t_menu where men_desc = 'ABM Rutas'))


INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values ((select fun_id from  SFX.t_funcionalidades where fun_nombre = 'abm_ciudad')
       , 'Alta de Ciudades', 'AltaCiudades',(select men_id from  SFX.t_menu where men_desc = 'ABM Ciudades'))

INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values ((select fun_id from  SFX.t_funcionalidades where fun_nombre = 'abm_ciudad')
       , 'Baja de Ciudades', 'BajaCiudades',(select men_id from  SFX.t_menu where men_desc = 'ABM Ciudades'))

INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values ((select fun_id from  SFX.t_funcionalidades where fun_nombre = 'abm_ciudad')
       , 'Modificación de Ciudades', 'ModificacionCiudades',(select men_id from  SFX.t_menu where men_desc = 'ABM Ciudades'))

INSERT INTO  SFX.t_menu (men_fun_id,men_desc,men_formulario , men_id_padre)
values ((select fun_id from  SFX.t_funcionalidades where fun_nombre = 'abm_ciudad')
       , 'Listado de Ciudades', 'ListadoCiudades',(select men_id from  SFX.t_menu where men_desc = 'ABM Ciudades'))

insert into SFX.t_menu values ( 'Alta de Aeronave',6,'AltaAeronaves',1);
insert into SFX.t_menu values ('Baja de Aeronaves',6,'BajaAeronaves',1);
insert into SFX.t_menu values ('Modificacion de Aeronave',6,'ModificacionAeronaves',1);
insert into SFX.t_menu values ('Listado de Aeronave',6,'ListadoAeronaves',1);
insert into SFX.t_menu values ( 'Alta de Rutas',5,'AltaAeronaves',2);
insert into SFX.t_menu values ('Baja de Rutas',5,'BajaAeronaves',2);
insert into SFX.t_menu values ('Modificacion de Rutas',5,'ModificacionAeronaves',2);
insert into SFX.t_menu values ('Listado de Rutas',5,'ListadoAeronaves',2);
...
/*****************************************************************************************/
--
CREATE FUNCTION SFX.fn_menu_usuario (@id_rol int)
RETURNS TABLE AS RETURN
SELECT COALESCE(m.men_id_padre,0) men_id_padre,mm.men_desc as desc_submenu, m.men_id, m.men_desc as descripcion
FROM SFX.t_func_rol r, SFX.t_menu m 
LEFT OUTER JOIN SFX.t_menu mm ON mm.men_id = m.men_id_padre
WHERE r.Fxr_Rol_Id = @id_rol
AND r.Fxr_Fun_Id = m.men_fun_id
GO

CREATE VIEW SFX.vw_Menu
AS
SELECT COALESCE(m.men_id_padre,0) men_id_padre,mm.men_desc as desc_submenu, m.men_id, m.men_desc as descripcion, m.men_formulario
FROM SFX.t_func_rol r, SFX.t_menu m 
LEFT OUTER JOIN SFX.t_menu mm ON mm.men_id = m.men_id_padre
WHERE r.Fxr_Fun_Id = m.men_fun_id
GO

CREATE VIEW SFX.vw_Rol_Func_Existencia
AS
SELECT r.Rol_Id, f.Fun_Id, f.fun_nombre,
     (select count(*)from sfx.t_func_rol fr
	  where fr.Fxr_Rol_Id = r.Rol_Id and fr.Fxr_Fun_Id = f.Fun_Id) as existencia
FROM SFX.t_roles r , SFX.t_funcionalidades f
UNION
SELECT 0 AS rol_id, f.Fun_Id, f.Fun_Nombre, 0 as existencia
FROM SFX.t_funcionalidades F
GO

CREATE FUNCTION SFX.fn_Busqueda_Roles (@rol varchar(255))
RETURNS TABLE
AS
RETURN
(
...
--Drop Type
IF EXISTS
( SELECT * FROM sys.types WHERE is_table_type = 1 AND name = 'inTablas') 
DROP TYPE SFX.inTablas
GO


CREATE TYPE SFX.inTablas AS TABLE (ID int primary key);
GO




CREATE PROCEDURE SFX.sp_ABM_Rol(@ID INT OUTPUT, @Nombre nvarchar(255), @Activo bit, @Funcionalidades SFX.inTablas READONLY)
AS
BEGIN TRANSACTION
    ...
    if @ID = 0
        BEGIN
            --Crear Nuevo Rol
            INSERT INTO SFX.t_roles VALUES (@Nombre, @Activo);
            SELECT @ID = SCOPE_IDENTITY();
            INSERT INTO SFX.t_func_rol SELECT ID, @ID From @Funcionalidades;
        END
    else
        begin
            --Modificar Rol Existente
            UPDATE SFX.t_roles SET Rol_Nombre = @Nombre, Rol_activo = @Activo Where Rol_Id = @ID;
            DELETE FROM SFX.t_func_rol
            Where Fxr_Rol_Id = @ID and Fxr_Fun_Id NOT IN (Select ID From @Funcionalidades);
            INSERT INTO SFX.t_func_rol
            SELECT ID, @ID From @Funcionalidades
            Where NOT EXISTS (Select 1 From SFX.t_func_rol Where Fxr_Rol_Id = @ID and Fxr_Fun_Id = ID);
            --Si se dió de baja el Rol, el trigger se va a encargar de eliminar el Rol para los Usuarios
        end
...
CREATE TRIGGER SFX.trg_rol_desactivado ON SFX.t_roles FOR UPDATE
AS
BEGIN TRANSACTION

/* Quita el Rol desactivado a aquellos Usuarios que lo referencian. */
DELETE FROM SFX.t_rol_usuario
Where EXISTS (Select 1 from INSERTED I Where I.Rol_Id = SFX.t_rol_usuario.Rxu_Rol_Id and I.Rol_activo = 0)
...
CREATE PROCEDURE [SFX].[IniciarSesion](
@userName	VARCHAR(8),
@password	CHAR(64),
@existe		BIT OUTPUT,
@usu_id		INT OUTPUT,
@cant_roles INT OUTPUT)
...
SELECT @existe = 1 ,  @usu_id = Usu_Id
	FROM [SFX].[t_usuarios]
	WHERE Usu_Username = @userName
	AND   Usu_Password =  @password;


--RAISERROR ('El usuario se encuentra desactivado.',16,1)
IF @existe = 1 
	--BEGIN
		SELECT @cant_roles = COUNT(*) FROM SFX.t_rol_usuario WHERE Rxu_Usu_Id = @usu_id		
	--END

--ELSE
	--BEGIN
	--	RAISERROR ('Usuario y/o contraseña incorrectos.',16,1)
    --END
...
BEGIN
	...
	select Via_Fecha_Salida as FechaSalida, Via_Fecha_Llegada_Estimada as FechaEstimada,
		   ...
		   (select SFX.KgDisponibles(Via_ID)) as KG_Disponibles, 
...
BEGIN TRY
	...
	UPDATE [SFX].[t_rutas] 
	   SET Rut_Fecha_Baja = getdate()
	 WHERE Rut_ID = @ID
	   AND Rut_Fecha_Baja IS NULL;
...
CREATE PROCEDURE [SFX].[InsertarRuta] 
	
	 @Rut_Codigo			numeric(18,0),
	 @Rut_Precio_BaseKG		numeric(18,2),
	 @Rut_Precio_BasePasaje numeric(18,2),
	 @Rut_Cia_ID_Origen		int,
	 @Rut_Cia_ID_Destino	int,
	 @Rut_Ser_ID			int
...
BEGIN TRY
	...
	INSERT INTO [SFX].[t_rutas] (Rut_Codigo, Rut_Precio_BaseKG, Rut_Precio_BasePasaje, Rut_Cia_ID_Origen, Rut_Cia_ID_Destino, Rut_Ser_ID) 
		 VALUES (@Rut_Codigo, @Rut_Precio_BaseKG, @Rut_Precio_BasePasaje, @Rut_Cia_ID_Origen, @Rut_Cia_ID_Destino, @Rut_Ser_ID);
...
--CREATE TRIGGER GDG.tr_inhabilitar_usuario ON Usuario FOR UPDATE
--AS
--BEGIN TRANSACTION

--/* Inactivar Usuarios que alcanzan los 3 intentos fallidos de logueo. */
--UPDATE GDG.Usuario SET activo = 0
--WHERE Exists (Select 1 From inserted I Where I.ID_Usr = GDG.Usuario.ID_Usr and I.Intentos_Fallidos = 3)
--  And Not Exists (Select 1 From deleted D Where D.ID_Usr = GDG.Usuario.ID_Usr and D.Intentos_Fallidos = 3)

--  UPDATE GDG.persona SET activo = 0
--WHERE Exists (Select 1 From inserted I Where I.ID_Usr = GDG.persona.ID_Usr and I.Intentos_Fallidos = 3)
--  And Not Exists (Select 1 From deleted D Where D.ID_Usr = GDG.persona.ID_Usr and D.Intentos_Fallidos = 3)  

--COMMIT
--GO


--select * from SFX.t_roles
--select * from [SFX].[t_funcionalidades] 
--select * from [SFX].[t_rol_usuario]
--select * from [SFX].[t_func_rol]
